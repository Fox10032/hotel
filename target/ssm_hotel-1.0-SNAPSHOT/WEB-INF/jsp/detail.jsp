                ...
                <div class="intro-txt">
                    ...
                    <div class="store-attrs">
                        <div class="summary">
                            ...
                            <p class="activity"><span>优惠价</span><strong class="price"><i>￥</i><span id="memberPrice">${room.price}</span></strong></p>
...
<div style="display: none;padding: 5px" id="orderRoomWindow">
    <form class="layui-form" style="width:90%;" id="dataFrm" lay-filter="dataFrm">
        ...
        <div class="layui-form-item" style="margin-left: 80px">
            <span style="color: red;font-size: 16px;">预订须知：请携带本人的身份证办理入住手续</span>
        </div>
